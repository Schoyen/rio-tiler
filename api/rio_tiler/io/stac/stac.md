...
class STACReader(
    ...
    include_asset_types: Set[str] = {'image/tiff; application=geotiff; profile=cloud-optimized', 'application/x-hdf', 'image/vnd.stac.geotiff; cloud-optimized=true', 'application/x-hdf5', 'image/tiff', 'image/tiff; application=geotiff', 'image/tiff; profile=cloud-optimized; application=geotiff', 'image/x.geotiff', 'image/jp2'},
